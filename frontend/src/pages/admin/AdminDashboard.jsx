...
import { Users, BookOpen, Calendar, Briefcase, Bell, ShieldAlert, Plus, UserCheck, UserX } from 'lucide-react';
...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    ...
    API.get('/admin/students')
      ...
      .catch(() => {
        setStudents([
          { _id: 's1', name: 'Alex Johnson', email: 'student@college.edu', department: 'Computer Science & Engineering', enrollmentNo: 'CSE-2024-089', isBlocked: false },
          { _id: 's2', name: 'Elena Rostova', email: 'elena@college.edu', department: 'Information Technology', enrollmentNo: 'IT-2024-042', isBlocked: false },
          { _id: 's3', name: 'Marcus Vance', email: 'marcus@college.edu', department: 'Artificial Intelligence', enrollmentNo: 'AI-2024-019', isBlocked: true }
        ]);
      });
  }, []);
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      <div className="glass-panel" style={{ padding: '1.5rem 2rem' }}>
        <div className="badge badge-indigo" style={{ marginBottom: '0.5rem' }}>Campus Administration</div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '1.5rem' }}>
        ...
        <div className="glass-card">
          ...
          <div style={{ fontSize: '2rem', fontWeight: 800, color: 'var(--accent-rose)', marginTop: '0.25rem' }}>{stats.blockedStudents}</div>
        </div>
        <div className="glass-card">
              ...
              {students.map((std) => (
                <tr key={std._id} style={{ borderBottom: '1px solid var(--border-color)' }}>
                  ...
                  <td style={{ padding: '0.85rem' }}>
                    <span className={std.isBlocked ? 'badge badge-rose' : 'badge badge-emerald'}>
